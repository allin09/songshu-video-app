<template>
	<view>
		<video :src="src" :controls="controls" :show-center-play-btn="false" :show-play-btn="false" :poster="poster" :style="{ height: height,width: width }"
		 :loop="true" @waiting="waiting" :enable-progress-gesture="false" @play="startPlay" @click="clickVideo" :id="`video_${src}`" ref="`video_${src}`"
		 class="video" @timeupdate="timeupdate"></video>
